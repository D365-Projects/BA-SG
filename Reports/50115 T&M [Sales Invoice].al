...
report 50115 "Standard Sales Invoice T&M"
{
    Caption = 'Sales - Confirmation-T&M';
    DefaultRenderingLayout = "T&M Invoice.rdl";
    ...
    rendering
    {
        layout("T&M Invoice.rdl")
        {
            Type = RDLC;
            LayoutFile = './Layouts/T&M Invoice.rdl';
            Caption = 'Standard Sales Invoice T&M Confirmation (RDLC)';
    ...
    var
        ...
        BodyLbl: Label 'Thank you for your business. Your Invoice confirmation is attached to this message.';
    ...
    protected var
        ...
        SalesConfirmationLbl: Label 'Invoice Confirmation';
