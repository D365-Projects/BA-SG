...
report 50107 "Pricing Sheet Sales Quote"
{
    Caption = 'Pricing Sales Quote';
    DefaultRenderingLayout = "PricingSheet.rdl";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            {
                UseTemporary = true; // Ensure this dataitem is only used as a temporary buffer as per deprecation notice
