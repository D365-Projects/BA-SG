report 50119 "Sales Quote_SG"
{
    ...
    DefaultRenderingLayout = "StandardSalesQuote_SG.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(Sell_to_Country_Reigon_Dec; "Sell-to Country/Reigon Dec") { }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    TotalAmount += LineAmount - "Inv. Discount Amount";
                    VatAmount += TotalAmount - GetLineAmountExclVAT();
    ...
    rendering
    {
        layout("StandardSalesQuote_SG.rdlc")
        {
            Type = RDLC;
            LayoutFile = './Layouts/StandardSalesQuote_SG.rdlc';
            Caption = 'Standard Sales Quote License (RDLC)';
            Summary = 'The Standard Sales Quote License (RDLC) is the most detailed layout and provides most flexible layout options.';
        }
