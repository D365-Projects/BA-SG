...
report 50123 "Sales Tax Device- Invoice_SG"
{
    ...
    DefaultRenderingLayout = "StandardSalesInvoiceDevice_SG.rdlc";
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            begin
                TotalAmount_IncludingTax := TotalAmountExclInclVATValue + TotalAmountVAT;
    ...
    rendering
    {
        layout("StandardSalesInvoiceDevice_SG.rdlc")
        {
            Type = RDLC;
            LayoutFile = './Layouts/Device PostedSalesInvoice.rdl';
            Caption = 'Sales Tax Invoice SG(RDLC)';
            Summary = 'The Standard Sales Invoice Tax SG(RDLC) is the most detailed layout and provides most flexible layout options.';
        }
