...
report 50124 "Sales Tax T&M- Invoice_SG"
{
    ...
    DefaultRenderingLayout = "StandardSalesInvoiceTM_SG.rdlc";
    ...
    rendering
    {
        layout("StandardSalesInvoiceTM_SG.rdlc")
        {
            Type = RDLC;
            LayoutFile = './Layouts/T&M PostedSalesInvoice.rdl';
