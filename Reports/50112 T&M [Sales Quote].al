...
report 50112 "Standard Sales Quote T&M"
{
    Caption = 'Sales Quote- Confirmation-T&M';
    DefaultRenderingLayout = "T&M Quote.rdl";
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(DisplayAsmInformation; DisplayAssemblyInformation)
                    {
                        ...
                        ToolTip = 'Specifies if you want the report to include information about components that were used in linked assembly Quotes that supplied the item(s) being sold. (Only possible for RDLC report layout.)';
                    }
    ...
    rendering
    {
        layout("T&M Quote.rdl")
        {
            Type = RDLC;
            LayoutFile = './Layouts/T&M Quote.rdl';
            Caption = 'Standard Sales Quote T&M Confirmation (RDLC)';
